describe("Customer credit balance", () => {
    it("unapplies excess credit", () => {
        ...
        cy.get(".moj-timeline__item").first().within((el) => {
            ...
            cy.get(".moj-timeline__date").contains("Outstanding balance: £40 Credit balance: £30");
    ...
    it("reapplies excess credit", () => {
        ...
        cy.get(".moj-timeline__item").first().within((el) => {
            ...
            cy.get(".moj-timeline__byline").contains(`by 0, ${now}`);
            cy.get(".moj-timeline__date").contains("Outstanding balance: £110 Credit balance: £0");
            cy.get(".govuk-list > li")
                .first().contains("3000 reapplied to AD000001/22");
        });
    });
});
