describe("Adjust invoice form", () => {
    it("adds a manual credit to an invoice", () => {
        ...
        cy.url().should('include', "clients/3/invoices?success=invoice-adjustment[CREDIT_MEMO]");
    ...
    it("writes off an invoice", () => {
        ...
        cy.url().should('include', "clients/3/invoices?success=invoice-adjustment[CREDIT_WRITE_OFF]");
