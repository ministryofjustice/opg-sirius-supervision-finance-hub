describe("Invoice Tab", () => {
        it("table with correct headers and content", () => {
            ...
            cy.get("table#invoices > tbody > tr")
                ...
                .next().should("contain", "£185")
                .next().should("contain", "£135");
        });
...
describe("Invoices ledger allocations", () => {
    it("table with correct headers and content", () => {
        ...
        cy.get('[data-cy="ledger-amount-data"]').first().contains("£185")
        ...
        cy.get('[data-cy="ledger-status-data"]').first().contains("Confirmed");
    });
});
