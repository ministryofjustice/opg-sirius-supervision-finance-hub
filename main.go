...
import (
	...
	"github.com/opg-sirius-supervision-finance-hub/internal/server"
...
func main() {
	logger := zap.Must(zap.NewProduction(zap.Fields(zap.String("service_name", "opg-sirius-supervision-finance-hub")))).Sugar()
	apiCallLogger := logging.New(os.Stdout, "opg-sirius-supervision-finance-hub")
