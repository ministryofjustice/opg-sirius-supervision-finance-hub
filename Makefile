...
scan: setup-directories
	...
	docker compose run --rm trivy image --format sarif --output /test-results/migration.sarif --exit-code 0 311462405659.dkr.ecr.eu-west-1.amazonaws.com/sirius/sirius-finance-migration:latest
