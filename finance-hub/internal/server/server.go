...
type ApiClient interface {
	GetCurrentUserDetails(sirius.Context) (shared.Assignee, error)
	GetPersonDetails(sirius.Context, int) (shared.Person, error)
	GetFeeReductions(sirius.Context, int) (shared.FeeReductions, error)
}
