...
func (suite *IntegrationSuite) Test_receipt_transactions_reversals() {
	...
	assert.Equal(suite.T(), "Refund [01/12/2025]", results[12]["Line description"], "Line description - Refund Reversal Debit")
	...
	assert.Equal(suite.T(), "Refund [01/12/2025]", results[13]["Line description"], "Line description - Refund Reversal Credit")
}
