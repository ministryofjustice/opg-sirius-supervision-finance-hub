...
func (suite *IntegrationSuite) Test_receipt_transactions() {
	...
	assert.Equal(suite.T(), fmt.Sprintf("Cheque payment [%s]", yesterday.Date().Format("02/01/2006")), results[11]["Line description"], "Line description - Cheques 1 & 2 Debit")
	...
	assert.Equal(suite.T(), "1816100000", results[12]["Account"], "Account - Cheques 1 & 2 Credit")
	...
	assert.Equal(suite.T(), fmt.Sprintf("Cheque payment [%s]", yesterday.Date().Format("02/01/2006")), results[12]["Line description"], "Line description - Cheques 1 & 2 Credit")
	...
	assert.Equal(suite.T(), fmt.Sprintf("Cheque payment [%s]", yesterday.Date().Format("02/01/2006")), results[13]["Line description"], "Line description - Cheques 3 Debit")
	...
	assert.Equal(suite.T(), "1816100000", results[14]["Account"], "Account - Cheques 3 Credit")
	...
	assert.Equal(suite.T(), fmt.Sprintf("Cheque payment [%s]", yesterday.Date().Format("02/01/2006")), results[14]["Line description"], "Line description - Cheques 3 Credit")
