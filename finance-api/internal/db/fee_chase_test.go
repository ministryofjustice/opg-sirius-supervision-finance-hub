...
func (suite *IntegrationSuite) Test_fee_chase() {
	...
	assert.Equal(suite.T(), "B2000001/0", results[0]["Invoice"], "Invoices - client 1")
	assert.Equal(suite.T(), "=UNICHAR(163)&90.99", results[0]["23"], "Invoices - client 1")
	assert.Equal(suite.T(), "AD000001/25", results[0]["24"], "Invoices - client 1")
	assert.Equal(suite.T(), "=UNICHAR(163)&100.00", results[0]["25"], "Invoices - client 1")
