...
func (suite *IntegrationSuite) Test_final_fee_debt() {
	...
	client1ID := suite.seeder.CreateClient(ctx, "Ian", "Test", "12345678", "DEATH_CONFIRMED")
	...
	client2ID := suite.seeder.CreateClient(ctx, "Wallace", "Gromit", "87654321", "REGAINED_CAPACITY")
	...
	client3ID := suite.seeder.CreateClient(ctx, "Ian", "McGregor", "12348765", "ACTIVE")
