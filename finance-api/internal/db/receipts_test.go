...
func (suite *IntegrationSuite) Test_receipts() {
	...
	clientID := suite.seeder.CreateClient(ctx, "Ian", "Test", courtRef1, "ACTIVE")
	...
	client2ID := suite.seeder.CreateClient(ctx, "Ernie", "Error", courtRef2, "ACTIVE")
	...
	client3ID := suite.seeder.CreateClient(ctx, "Colette", "Correct", courtRef3, "ACTIVE")
