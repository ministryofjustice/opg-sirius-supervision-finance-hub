...
func (suite *IntegrationSuite) Test_receipts() {
	...
	assert.Equal(suite.T(), "1816100000", results[6]["Receivables account code"], "Line 7: Receivables account code")
	assert.Equal(suite.T(), "CA - TRADE RECEIVABLES", results[6]["Account code description"], "Line 7: Account code description")
	...
	assert.Equal(suite.T(), "1816100002", results[7]["Receivables account code"], "Line 8: Receivables account code")
	assert.Equal(suite.T(), "CA - TRADE RECEIVABLES - ON ACCOUNT RECEIPTS", results[7]["Account code description"], "Line 8: Account code description")
	...
	assert.Equal(suite.T(), "1816100000", results[8]["Receivables account code"], "Line 9: Receivables account code")
	assert.Equal(suite.T(), "CA - TRADE RECEIVABLES", results[8]["Account code description"], "Line 9: Account code description")
	assert.Equal(suite.T(), "OC"+inv4Ref, results[8]["Txn number"], "Line 9: Txn number")
	...
	assert.Equal(suite.T(), "-100.00", results[8]["Amount applied"], "Line 9: Amount applied")
	assert.Equal(suite.T(), "0.00", results[8]["Amount unapplied"], "Line 9: Amount unapplied")
	...
	assert.Equal(suite.T(), "1816100002", results[9]["Receivables account code"], "Line 10: Receivables account code")
	assert.Equal(suite.T(), "CA - TRADE RECEIVABLES - ON ACCOUNT RECEIPTS", results[9]["Account code description"], "Line 10: Account code description")
	assert.Equal(suite.T(), "OC"+courtRef2, results[9]["Txn number"], "Line 10: Txn number")
	...
	assert.Equal(suite.T(), "0.00", results[9]["Amount applied"], "Line 10: Amount applied")
	assert.Equal(suite.T(), "-50.00", results[9]["Amount unapplied"], "Line 10: Amount unapplied")
	...
	assert.Equal(suite.T(), "1816100000", results[10]["Receivables account code"], "Line 11: Receivables account code")
	assert.Equal(suite.T(), "CA - TRADE RECEIVABLES", results[10]["Account code description"], "Line 11: Account code description")
	...
	assert.Equal(suite.T(), "1816100002", results[11]["Receivables account code"], "Line 12: Receivables account code")
	assert.Equal(suite.T(), "CA - TRADE RECEIVABLES - ON ACCOUNT RECEIPTS", results[11]["Account code description"], "Line 12: Account code description")
