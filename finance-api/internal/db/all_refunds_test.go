...
func (suite *IntegrationSuite) Test_all_refunds() {
	...
	assert.Equal(suite.T(), "2025-06-17", results[0]["Create date"], "Create date - client 1")
	...
	assert.Equal(suite.T(), "2025-06-17", results[0]["Status Date"], "Status Date - client 1")
	...
	assert.Equal(suite.T(), "2025-06-17", results[1]["Create date"], "Create date - client 2")
	...
	assert.Equal(suite.T(), "2025-06-18", results[1]["Status Date"], "Status Date - client 2")
	...
	assert.Equal(suite.T(), "2025-06-15", results[2]["Create date"], "Create date - client 3")
	...
	assert.Equal(suite.T(), "2025-06-17", results[2]["Status Date"], "Status Date - client 3")
	...
	assert.Equal(suite.T(), "2025-06-14", results[3]["Create date"], "Create date - client 4")
	...
	assert.Equal(suite.T(), "2025-06-16", results[3]["Status Date"], "Status Date - client 4")
}
