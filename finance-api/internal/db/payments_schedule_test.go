...
func (suite *IntegrationSuite) Test_payments_schedules() {
	...
	// client 2
	client2ID := suite.seeder.CreateClient(ctx, "Alan", "Intelligence", courtRef2, "ACTIVE")
	...
	// client 3
	client3ID := suite.seeder.CreateClient(ctx, "C", "Lient", courtRef3, "ACTIVE")
	...
	client5ID := suite.seeder.CreateClient(ctx, "Ernie", "Error", courtRef4, "ACTIVE")
	...
	client6ID := suite.seeder.CreateClient(ctx, "Colette", "Correct", courtRef5, "ACTIVE")
	...
	// cheques
	client7ID := suite.seeder.CreateClient(ctx, "Ian", "Test", courtRef6, "ACTIVE")
