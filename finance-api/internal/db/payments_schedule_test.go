...
func (suite *IntegrationSuite) Test_payments_schedules() {
	...
	suite.seeder.CreatePayment(ctx, 15000, yesterday.Date(), courtRef4, shared.TransactionTypeOnlineCardPayment, yesterday.Date())
	...
	suite.seeder.ReversePayment(ctx, courtRef4, courtRef5, "150.00", yesterday.String(), yesterday.String(), shared.TransactionTypeOnlineCardPayment)
