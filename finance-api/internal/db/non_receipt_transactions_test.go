...
func (suite *IntegrationSuite) Test_non_receipt_transactions() {
	...
	suite.seeder.CreatePayment(ctx, 1200, yesterday.Date(), "12345678", shared.TransactionTypeMotoCardPayment, nil, yesterday.Date())
	...
	suite.seeder.CreatePayment(ctx, 1000, yesterday.Date(), "87654321", shared.TransactionTypeDirectDebitPayment, nil, yesterday.Date())
	...
	suite.seeder.CreatePayment(ctx, 1000, yesterday.Date(), "12344321", shared.TransactionTypeDirectDebitPayment, nil, yesterday.Date())
	suite.seeder.CreatePayment(ctx, 1500, yesterday.Date(), "12344321", shared.TransactionTypeReapply, nil, yesterday.Date())
	...
	assert.Equal(suite.T(), "200.00", results[12]["Debit"], "Debit - AD Remissions & Exemptions Debit")
	...
	assert.Equal(suite.T(), "200.00", results[13]["Credit"], "Credit - AD Remissions & Exemptions Credit")
