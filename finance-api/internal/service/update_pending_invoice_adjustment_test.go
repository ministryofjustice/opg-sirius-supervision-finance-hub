...
func (suite *IntegrationSuite) TestService_UpdatePendingInvoiceAdjustment() {
	...
	seeder.SeedData(
		...
		"INSERT INTO ledger VALUES (NEXTVAL('ledger_id_seq'), 'existing', '2022-04-11T00:00:00+00:00', '', 10300, '', 'ONLINE CARD PAYMENT', 'CONFIRMED', 3, NULL, NULL, '11/04/2022', '12/04/2022', 1254, '', '', 1, '05/05/2022', 2);",
		...
		"INSERT INTO ledger VALUES (NEXTVAL('ledger_id_seq'), 'fully-paid', '2022-04-11T00:00:00+00:00', '', 12300, '', 'ONLINE CARD PAYMENT', 'CONFIRMED', 4, NULL, NULL, '11/04/2022', '12/04/2022', 1254, '', '', 1, '05/05/2022', 2);",
...
func (suite *IntegrationSuite) Test_setAdjustmentDecision_LinkedToNonConfirmedLedgerDoesNotApplyInvoiceReduction() {
	{
		...
		seeder.SeedData(
			"INSERT INTO finance_client VALUES (1, 1, '1234', 'DEMANDED', NULL);",
			"INSERT INTO invoice VALUES (1, 1, 1, 'S2', 'reject', '2019-04-01', '2020-03-31', 12300, NULL, '2020-03-20',1, '2020-03-16', 10, NULL, NULL, '2019-06-06', NULL);",
			"INSERT INTO ledger VALUES (NEXTVAL('ledger_id_seq'), 'fully-paid', '2022-04-11T00:00:00+00:00', '', 12300, '', 'ONLINE CARD PAYMENT', 'APPROVED', 1, NULL, NULL, '11/04/2022', '12/04/2022', 1254, '', '', 1, '05/05/2022', 2);",
...
func (suite *IntegrationSuite) Test_setAdjustmentDecision_LinkedToConfirmedLedgerAppliesInvoiceReduction() {
	{
		...
		seeder.SeedData(
			"INSERT INTO finance_client VALUES (1, 1, '1234', 'DEMANDED', NULL);",
			"INSERT INTO invoice VALUES (1, 1, 1, 'S2', 'reject', '2019-04-01', '2020-03-31', 12300, NULL, '2020-03-20',1, '2020-03-16', 10, NULL, NULL, '2019-06-06', NULL);",
			"INSERT INTO ledger VALUES (NEXTVAL('ledger_id_seq'), 'fully-paid', '2022-04-11T00:00:00+00:00', '', 12300, '', 'ONLINE CARD PAYMENT', 'CONFIRMED', 1, NULL, NULL, '11/04/2022', '12/04/2022', 1254, '', '', 1, '05/05/2022', 2);",
