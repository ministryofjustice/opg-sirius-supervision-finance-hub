...
func (suite *IntegrationSuite) Test_processReversals() {
	...
	seeder.SeedData(
		...
		"INSERT INTO invoice VALUES (16, 15, 15, 'AD', 'test 15 unpaid', '2023-04-01', '2025-03-31', 10000, NULL, '2024-03-31', NULL, '2024-03-31', NULL, NULL, NULL, '2024-03-31 00:00:00', '99');",
		"INSERT INTO ledger VALUES (17, 'test 15', '2025-01-02 15:32:10', '', 5000, 'payment 15 being reversed', 'SUPERVISION CHEQUE PAYMENT', 'CONFIRMED', 15, NULL, NULL, NULL, '2025-01-02', NULL, NULL, NULL, NULL, '2025-01-02', 1, 101);",
	...
	tests := []struct {
	...
	}{
		{
			...
			records: [][]string{
				...
				{"SUPERVISION CHEQUE PAYMENT", "1515", "1616", "02/01/2025", "02/01/2025", "50.00", "101"}, // successful match
			},
			allocations: []createdReversalAllocation{
				{
					ledgerAmount:     -1000,
