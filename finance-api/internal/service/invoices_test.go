...
func TestService_GetInvoices(t *testing.T) {
	testDB.SeedData(
		"INSERT INTO finance_client VALUES (2, 1, '1234', 'DEMANDED', null, 12300, 2222);",
		"INSERT INTO finance_client VALUES (3, 1, '1234', 'DEMANDED', null, 12300, 2222);",
		"INSERT INTO fee_reduction VALUES (1, 1, 'REMISSION', null, '2019-04-01'::date, '2020-03-31'::date, 'notes', false, '2019-05-01'::date);",
		...
		"INSERT INTO invoice_fee_range (id, supervisionlevel, fromdate, todate, amount) VALUES (1, 'General', '2022-04-01', '2023-03-31', 12300);",
	)
