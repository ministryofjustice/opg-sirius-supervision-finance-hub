			...
			allocations: []createdReversalAllocation{
				{
					...
					receivedDate:     time.Date(2025, 9, 10, 00, 00, 00, 0, time.UTC),
				...
				},
				{
					...
					ledgerType:       "DIRECT DEBIT PAYMENT",
					ledgerStatus:     "CONFIRMED",
					receivedDate:     time.Date(2025, 9, 01, 00, 00, 00, 0, time.UTC),
