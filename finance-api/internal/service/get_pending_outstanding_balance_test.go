...
func (suite *IntegrationSuite) TestService_GetPendingOutstandingBalance() {
	...
	seeder.SeedData(
		...
		"INSERT INTO ledger VALUES (1, 'Paid in one', '2022-04-11T08:36:40+00:00', '', 32000, '', 'CARD PAYMENT', 'CONFIRMED', 1, NULL, NULL, '2022-04-11', '2022-04-12', 1254, '', '', 1, '2022-05-05', 2, NULL, '2022-05-05');",
		"INSERT INTO ledger VALUES (2, 'Paid in one but...', '2022-04-11T08:36:40+00:00', '', 32000, '', 'CARD PAYMENT', 'CONFIRMED', 1, NULL, NULL, '2022-04-11', '2022-04-12', 1254, '', '', 1, '2022-05-05', 2, NULL, '2022-05-05');",
		"INSERT INTO ledger VALUES (3, '... fee reduction causes unapply', '2022-04-11T08:36:40+00:00', '', 0, '', 'CREDIT REMISSION', 'CONFIRMED', 1, NULL, NULL, '2022-04-11', '2022-04-12', 1254, '', '', 1, '2022-05-05', 2, NULL, '2022-05-05');",
		"INSERT INTO ledger VALUES (4, 'Refund', '2022-04-11T08:36:40+00:00', '', 5000, '', 'REFUND', 'CONFIRMED', 1, NULL, NULL, '2022-04-11', '2022-04-12', 1254, '', '', 1, '2022-05-05', 2, NULL, '2022-05-05');",
	...
	tests := []struct {
		...
		{
			name: "returns zero outstanding when client exists but has no invoices",
			id:   3,
			want: 0,
		},
	}
