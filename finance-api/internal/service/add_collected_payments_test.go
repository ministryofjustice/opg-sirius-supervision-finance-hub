...
func (suite *IntegrationSuite) Test_AddCollectedPayments() {
	...
	seeder.SeedData(
		...
		"INSERT INTO pending_collection VALUES (1, 1, '2025-12-12', 15000, NULL, '2025-08-21', 1);",
		"INSERT INTO pending_collection VALUES (2, 2, '2025-06-06', 10000, NULL, '2025-08-21', 1);",
		"INSERT INTO pending_collection VALUES (3, 3, '2025-06-06', 15000, NULL, '2025-08-21', 1);",
		"INSERT INTO pending_collection VALUES (4, 1, '2025-06-06', 10000, 1, '2025-08-21', 1);", // already processed (somehow)
	...
	for _, tt := range tests {
		suite.T().Run(tt.name, func(t *testing.T) {
			...
			rows, err := seeder.Query(suite.ctx,
				`SELECT l.amount, l.type, l.datetime, l.bankdate
						FROM ledger l
			...
			for rows.Next() {
				...
				err = rows.Scan(&r.amount, &r.paymentType, &r.receivedDate, &r.bankDate)
