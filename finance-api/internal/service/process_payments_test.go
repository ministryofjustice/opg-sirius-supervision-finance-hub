...
func (suite *IntegrationSuite) Test_processPayments() {
	...
	seeder.SeedData(
		...
		"INSERT INTO ledger VALUES (1, 'ref', '2024-01-01 15:30:27', '', 10000, 'payment', 'MOTO CARD PAYMENT', 'CONFIRMED', 4, NULL, NULL, NULL, '2024-01-01', NULL, NULL, NULL, NULL, '2020-05-05', 1, NULL, '2020-05-05');",
