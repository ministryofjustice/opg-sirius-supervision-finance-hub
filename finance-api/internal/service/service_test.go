...
func (m *mockDispatch) PendingInvoiceAdjustmentAdded(ctx context.Context, event event.PendingInvoiceAdjustment) error {
	m.event = event
	m.called = append(m.called, "pending-invoice-adjustment")
	return nil
}
