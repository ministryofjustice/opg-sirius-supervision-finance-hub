...
const (
	customerCreditQuery = `SELECT SUM(la.amount) FROM finance_client fc 
...
func (suite *IntegrationSuite) TestService_reapplyCredit_noInvoices() {
	...
	conn.SeedData(
		...
		"INSERT INTO ledger_allocation VALUES (2, 2, NULL, '2020-04-02T00:00:00+00:00', 10000, 'ALLOCATED', NULL, '', '2020-04-02', NULL);",
	)
	s := NewService(conn.Conn)
	s.reapplyCredit(ctx, 1)
...
func (suite *IntegrationSuite) TestService_reapplyCredit_oldestFirst() {
	...
	conn.SeedData(
		...
		"INSERT INTO invoice VALUES (1, 1, 1, 'S2', 'S200001/20', '2020-04-02', '2020-04-02', 10000, NULL, NULL, NULL, '2020-04-02', NULL, NULL, 0, '2020-04-02', 1);",
		"INSERT INTO ledger VALUES (2, '2', '2020-04-02T00:00:00+00:00', '', 5000, 'half paid', 'CREDIT REMISSION', 'CONFIRMED', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2020-05-0', 1);",
		"INSERT INTO ledger_allocation VALUES (2, 2, NULL, '2020-04-02T00:00:00+00:00', 5000, 'ALLOCATED', NULL, '', '2020-04-02', NULL);",
	...
	conn.Prepare(ctx, "invoice_balance", invoiceBalanceForQuery)
