...
// SubWorkingDays will subtract n working days from the given date, skipping holidays and weekends.
// If the holiday cache needs refreshing, it will refresh it before performing the calculation.
