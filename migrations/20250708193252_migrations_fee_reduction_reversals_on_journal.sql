...
VALUES
       ('FRR', 'AD', 'FEE REDUCTION REVERSAL', 4481102114, 'Fee Reduction Reversal', 'AD Fee reduction reversal', false),
       ('FRR', 'GENERAL', 'FEE REDUCTION REVERSAL', 4481102115, 'Fee Reduction Reversal', 'General Fee reduction reversal', false),
       ('FRR', 'MINIMAL', 'FEE REDUCTION REVERSAL', 4481102120, 'Fee Reduction Reversal', 'Minimal Fee reduction reversal', false),
