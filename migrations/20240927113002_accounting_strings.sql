-- +goose Up
CREATE TABLE supervision_finance.cost_centre
(
    code                    INT     NOT NULL PRIMARY KEY,
    cost_centre_description VARCHAR NOT NULL
);

INSERT INTO supervision_finance.cost_centre (code, cost_centre_description)
VALUES (99999999, 'BALANCE SHEET'),
       (10482009, 'Supervision Investigations'),
       (10486000, 'Allocations, HW & SIS BISD');

CREATE TABLE supervision_finance.account
(
    code                     BIGINT  NOT NULL PRIMARY KEY,
    account_code_description VARCHAR NOT NULL,
    cost_centre              INTEGER REFERENCES supervision_finance.cost_centre (code)
);

INSERT INTO supervision_finance.account(code, account_code_description, cost_centre)
...
CREATE TABLE supervision_finance.transaction_type
(
...
CREATE INDEX ON supervision_finance.transaction_type (fee_type, supervision_level);

INSERT INTO supervision_finance.transaction_type (fee_type, supervision_level, account_code, description)
